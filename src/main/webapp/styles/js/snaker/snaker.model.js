...
$.extend(true,snakerflow.config.props.props,{
	...
	instanceUrl : {name:'instanceUrl', label:'表单', value:'', editor:function(){return new snakerflow.editors.inputEditor();}},
	type : {name:'type', label:'类型', value:'', editor:function(){return new snakerflow.editors.inputEditor();}},
...
$.extend(true,snakerflow.config.tools.states,{
	...
	task : {
		...
		props : {
			...
			//assigneeDisplay: {name:'assigneeDisplay', label: '参与者', value:'', editor: function(){return new snakerflow.editors.inputEditor('/dialogs/selectDialog.jsp?type=orgUserTree');}},
