...
<html>
	...
	<body>
	<form id="mainForm" action="${ctx}/custom/dms/file/up" method="get">
		...
		<table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				<td align=center width=15% class="td_list_1">文件编码</td>
				<td align=center width=25% class="td_list_1">文件名称</td>
				<td align=center width=5% class="td_list_1">文件版本</td>
				<td align=center width=10% class="td_list_1">上传时间</td>
				<td align=center width=5% class="td_list_1">上传人</td>
				<td align=center width=5% class="td_list_1">复核人</td>
						...
						<c:if test="${empty lookup}">
							<c:if test="${item.status > 0}">
								...
								<c:if test="${(item.status==3) && userId!=item.updaterId}">
									<shiro:hasPermission name="dms_file_up_review">
										<a href="${ctx}/custom/dms/file/up/update/${item.id}" class="btnEdit" title="复核">复核</a>
									</shiro:hasPermission>
								</c:if>
							</c:if>
