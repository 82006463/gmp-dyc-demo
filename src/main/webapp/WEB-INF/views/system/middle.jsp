...
<html lang="en">
<head>
    <link href="${ctx}/styles/css/style.css" type="text/css" rel="stylesheet"/>
...
<body onload="myLoad()">
    <div id="switchpic">
        <a href="javascript:switchLayout()"><img src="${ctx}/styles/images/switch_left.gif" alt="隐藏左侧导航栏" id="arrow"/></a>
    </div>
</body>
</html>
