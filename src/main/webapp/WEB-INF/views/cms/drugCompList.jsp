	...
	<form id="mainForm" action="${ctx}/custom/cms/customerComp" method="get">
				...
				<td align="left">
					<c:if test="${empty lookup}">
						<shiro:hasPermission name="cms_drugComp_edit">
							<input type='button' onclick="addNew('${ctx}/custom/cms/drugComp/create')" class='button_70px' value='新建'/>
						</shiro:hasPermission>
					</c:if>
					<c:if test="${!empty lookup}">
		...
		<table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td align=center width=20% class="td_list_1">药企名称</td>
