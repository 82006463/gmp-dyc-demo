			...
			<table class="table_all" align="center" border="0" cellpadding="0" cellspacing="0" style="margin-top: 0px">
				<tr>
					...
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="name" name="name" value="${entity.name}" />
					</td>
				</tr>
				<tr>
					<td class="td_table_1">上级菜单：</td>
					<td class="td_table_2" colspan="3">
						<input type="hidden" id="parentMenuId" name="parentMenuId" value="${entity.parentMenu.id}">
						<input type="text" id="parentMenuName" readonly="readonly" name="parentMenuName" class="input_240" value="${entity.parentMenu.name}">
						<input type='button' class='button_70px' value='上级菜单' id="selectMenu" onclick="openMenu()"/>
					</td>
				</tr>
				<tr>
					<td class="td_table_1">排序值：</td>
					<td class="td_table_2" colspan="3">
						<input type="text" class="input_240" id="orderby" name="orderby" value="${entity.orderby}" />
					</td>
				</tr>
			</table>
