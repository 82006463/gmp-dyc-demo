		...
		<table align="center" border="0" cellpadding="0"
			...
			<tr>
				...
				<shiro:hasPermission name="PROCESSDEPLOY">
					<input type='button' onclick="addNew('${ctx}/flow/process/designer')" class='button_70px' value='设计'/>
					<input type='button' onclick="addNew('${ctx}/flow/process/deploy')" class='button_70px' value='部署'/>
