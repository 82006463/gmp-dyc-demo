...
import com.zhanlu.custom.dm.service.BackupWinLogService;
 ...
 */
@Controller
@RequestMapping(value = "/custom/dm/backupWinLog")
public class BackupWinLogController {

    @Resource(name = "jdbcTemplate")
    private JdbcTemplate jdbcTemplate;
    @Autowired
    private BackupWinLogService backupWinLogService;
    @Autowired
    private CustomService customService;

    @RequestMapping(method = RequestMethod.GET)
    public ModelAndView list(Page<BackupWinLog> page, HttpServletRequest request) {
        ...
        page = backupWinLogService.findPage(page, filters);
        ModelAndView mv = new ModelAndView("dm/backupWinLogList");
    ...
    public ModelAndView create() {
        ModelAndView mv = new ModelAndView("dm/backupWinLogEdit");
        BackupWinLog entity = new BackupWinLog();
        entity.setStatus(1);
    ...
    public ModelAndView edit(@PathVariable("id") Long id) {
        BackupWinLog entity = backupWinLogService.findById(id);
        ModelAndView mv = new ModelAndView("dm/backupWinLogEdit");
        mv.addObject("entity", entity);
        return mv;
    }
    ...
    public ModelAndView update(BackupWinLog entity, HttpServletRequest req) {
        ...
        backupWinLogService.saveOrUpdate(entity);
        ModelAndView mv = new ModelAndView("redirect:/custom/dm/backupWinLog");
        return mv;
    }
    ...
    public ModelAndView view(@PathVariable("id") Long id) {
        BackupWinLog entity = backupWinLogService.findById(id);
        ModelAndView mv = new ModelAndView("dm/backupWinLogView");
        mv.addObject("entity", entity);
        return mv;
    }
    ...
    public Object check(Equipment entity, HttpServletRequest req) {
        ...
        if (entity.getId() == null || entity.getId().longValue() < 1) {
            ...
            BackupWinLog tmp = backupWinLogService.findById(entity.getId());
            if (!resultMap.containsKey("msg") && StringUtils.isNotBlank(entity.getCode())) {
                maps = jdbcTemplate.queryForList(sqlBuf.toString() + " AND code='" + entity.getCode() + "'");
