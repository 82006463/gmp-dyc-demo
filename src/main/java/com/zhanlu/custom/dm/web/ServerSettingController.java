...
import com.zhanlu.custom.dm.service.ServerSettingService;
 ...
 */
@Controller
@RequestMapping(value = "/custom/dm/serverSetting")
public class ServerSettingController {
    ...
    public ModelAndView list(Page<ServerSetting> page, HttpServletRequest request) {
        ...
        page = serverSettingService.findPage(page, filters);
        ModelAndView mv = new ModelAndView("dm/serverSettingList");
    ...
    public ModelAndView create() {
        ModelAndView mv = new ModelAndView("dm/serverSettingEdit");
        ServerSetting entity = new ServerSetting();
        entity.setStatus(1);
    ...
    public ModelAndView edit(@PathVariable("id") Long id) {
        ServerSetting entity = serverSettingService.findById(id);
        ModelAndView mv = new ModelAndView("dm/serverSettingEdit");
        mv.addObject("entity", entity);
        return mv;
    }
    ...
    public ModelAndView update(ServerSetting entity, HttpServletRequest req) {
        ...
        serverSettingService.saveOrUpdate(entity);
        ModelAndView mv = new ModelAndView("redirect:/custom/dm/serverSetting");
        return mv;
    }
    ...
    public ModelAndView view(@PathVariable("id") Long id) {
        ServerSetting entity = serverSettingService.findById(id);
        ModelAndView mv = new ModelAndView("dm/serverSettingView");
        mv.addObject("entity", entity);
        return mv;
    }
    ...
    public Object check(ServerSetting entity, HttpServletRequest req) {
        User user = customService.getUser(req);
        ...
        if (entity.getId() == null || entity.getId().longValue() < 1) {
            ...
            ServerSetting tmp = serverSettingService.findById(entity.getId());
            if (!resultMap.containsKey("msg") && StringUtils.isNotBlank(entity.getCode())) {
                maps = jdbcTemplate.queryForList(sqlBuf.toString() + " AND code='" + entity.getCode() + "'");
