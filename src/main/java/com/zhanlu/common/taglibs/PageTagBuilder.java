package com.zhanlu.common.taglibs;
...
public class PageTagBuilder implements TagBuilder {
    ...
    private String buildPageMessage() {
        ...
        sb.append("总共<font color='red'>" + totalRecords + "</font>条记录&nbsp; 共");
        sb.append("<font color='red'>" + totalPages + "</font>页&nbsp; 当前所在第");
        sb.append("<font color='red'>" + curPage + "</font>页");
        sb.append("</div></td>");
        return sb.toString();
    }
    ...
    private String buildPageLink() {
        ...
        sb.append("<a href='javascript:jumpPage(" + prePage + ")' style='TEXT-DECORATION: none'>上一页</a>&nbsp;&nbsp;");
        sb.append("<a href='javascript:jumpPage(" + nextPage + ")' style='TEXT-DECORATION: none'>下一页</a>&nbsp;&nbsp;");
        sb.append("<a href='javascript:jumpPage(" + totalPages + ")' style='TEXT-DECORATION: none'>末页</a>");
        return sb.toString();
    }
    ...
    private String buildPageButton() {
        StringBuffer sb = new StringBuffer();
        sb.append("<td><input type='hidden' name='lastpage' value='" + totalPages + "'/>");
        sb.append("转至第<input maxLength=5 name='jumppage' size=2 value='" + curPage + "'/>页 &nbsp;&nbsp;");
        sb.append("<input type='button' name='pagesubmit' onclick='return gotoPage()' class='button_70px' value='跳转'/>");
        sb.append("</td><td>");
