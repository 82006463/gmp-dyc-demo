...
import com.zhanlu.framework.common.utils.ServletUtils;
 ...
 * @author calvin
 */
public class PropertyFilterBean {
     ...
     * @param value      待比较的值.
     */
    public PropertyFilterBean(final String filterName, final String value) {
        ...
        propertyNames = StringUtils.splitByWholeSeparator(propertyNameStr, PropertyFilterBean.OR_SEPARATOR);
     ...
     */
    public static List<PropertyFilterBean> buildFromHttpRequest(final HttpServletRequest request) {
     ...
     */
    public static List<PropertyFilterBean> buildFromHttpRequest(final HttpServletRequest request, final String filterPrefix) {
        List<PropertyFilterBean> filterList = new ArrayList<>();
        ...
        for (Map.Entry<String, Object> entry : filterParamMap.entrySet()) {
            ...
            if (StringUtils.isNotBlank(value)) {
                PropertyFilterBean filter = new PropertyFilterBean(filterName, value);
